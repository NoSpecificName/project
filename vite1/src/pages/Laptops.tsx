...
const Laptops: React.FC = () => {
  ...
  const handleSearch = async (searchQuery?: string) => {
    ...
    try {
      const response = await axios.get(`https://api.techspecs.io/v5.0/search?query=${encodeURIComponent(queryToUse)}&category=laptops&api_key=vggdi2am3kh9mkm`);
  ...
  return (
    <div style={{ backgroundColor: '#003366', minHeight: '100vh', color: 'white', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ padding: '2.3rem', textAlign: 'center', flex: 1 }}>
        <h2>Laptops - Tech Specs Hub</h2>
        <p>Explore detailed specifications for laptops.</p>
